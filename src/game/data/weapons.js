...
export const WEAPONS = {
  ranged: {
    ...
    baseDmg: 15, dmgPerLevel: 5, // Adjusted for player 100HP baseline
  ...
  melee_slash: {
    ...
    baseDmg: 50, dmgPerLevel: 15, // Adjusted for player 100HP baseline
  ...
  melee_orbit: {
    ...
    baseDmg: 30, dmgPerLevel: 10, // Adjusted for player 100HP baseline
  ...
  melee_burst: {
    ...
    baseDmg: 70, dmgPerLevel: 20, // Adjusted for player 100HP baseline
  ...
  boomerang: {
    ...
    baseDmg: 25, dmgPerLevel: 8, // Adjusted for player 100HP baseline
